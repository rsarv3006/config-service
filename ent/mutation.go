...
func (m *AppConfigMutation) SetStatus(a appconfig.Status) {
	m.status = &a
}

// Status returns the value of the "status" field in the mutation.
func (m *AppConfigMutation) Status() (r appconfig.Status, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// If the AppConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AppConfigMutation) OldStatus(ctx context.Context) (v appconfig.Status, err error) {
	if !m.op.Is(OpUpdateOne) {
