...
func (acq *AppConfigQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (acq *AppConfigQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (acq *AppConfigQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (acq *AppConfigQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (acq *AppConfigQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (acq *AppConfigQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := acq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (acq *AppConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(appconfig.Table, appconfig.Columns, sqlgraph.NewFieldSpec(appconfig.FieldID, field.TypeUUID))
	_spec.From = acq.sql
